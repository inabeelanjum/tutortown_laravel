...
<?php $__env->startSection('content'); ?>
    <div class="login-dark" style="margin-top: 0px;">
        <form method="POST" style="margin-top: 50px;" action="<?php echo e(route('register')); ?>">
                        <?php echo csrf_field(); ?>
            <h2 class="sr-only">Login Formlo</h2>
            <div class="illustration" style="height: 155px;"><i class="icon ion-ios-locked-outline"></i></div>
            <div class="form-group"> <input id="name" placeholder= "Name" type="text" class="form-control <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?></div>
            <div class="form-group"><input id="password" type="password" placeholder="Enter Password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\tutor_town\resources\views/auth/register.blade.php ENDPATH**/ ?>